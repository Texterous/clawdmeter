...
// There is one target: the SmallTV-Ultra's ESP-12F (ESP8266). The indirection
// stays because it keeps SDK includes and chip quirks out of the feature code,
// and because a future ESP32-C2 batch would slot in here rather than everywhere.
#pragma once
#include <Arduino.h>
#include <time.h>
